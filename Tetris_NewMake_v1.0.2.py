...
def main():
    ...
    BASICFONT = pygame.font.Font('/Users/min/Library/Fonts/210 맨발의청춘L.ttf', 18)
    BIGFONT = pygame.font.Font('/Users/min/Library/Fonts/210 맨발의청춘L.ttf', 100)
    pygame.display.set_caption('***Moongs Tetris***')
    ...
    if choose == 0:
        ...
        '''if MUTE == 0 :
            if random.randint(0, 1) == 0:
                pygame.mixer.music.load('/Users/min/Downloads/Test.mp3')
            else:
                pygame.mixer.music.load('/Users/min/Downloads/Test.mp3')
                ...
                if BLIND == 1:
                    for i in range(BOARDWIDTH):
                        for j in range(BOARDHEIGHT):
                            drawBox(WINDOWWIDTH, WINDOWHEIGHT, board[i][j])
...
def drawBox(boxx, boxy, color, pixelx=None, pixely=None):
    ...
    pygame.draw.rect(DISPLAYSURF, BLACK, (pixelx - 1, pixely - 1, BOXSIZE + 0.5, BOXSIZE + 0.5))
    pygame.draw.rect(DISPLAYSURF, WHITE, (pixelx + 1, pixely + 1, BOXSIZE - 1, BOXSIZE - 1))
    pygame.draw.rect(DISPLAYSURF, color, (pixelx + 1, pixely + 1, BOXSIZE - 4, BOXSIZE - 4))
...
def dumbmenu(screen, menu, x_pos=500, y_pos=300, font=None, size=70, distance=1.4, fgcolor=(255, 255, 255),
