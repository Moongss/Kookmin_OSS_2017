	...
	for event in pg.event.get():
		...
		#Check for key down has been pressed
			...
			if event.key == pg.K_UP:
				...
				if pauseBtnState == 1:
					pg.mixer.music.load('/Users/min/Downloads/Test.mp3')
...
def checkKeydownEvents(event, setting, screen, stats, sb, playBtn, quitBtn, sel, ship, aliens, bullets, eBullets, pauseBtnState):
	...
	if event.key == pg.K_RIGHT:
		...
		effect = pg.mixer.Sound('/Users/min/Downloads/SuperMario/Throwing fireball.wav')
		effect.play()
...
def checkBulletAlienCol(setting, screen, stats, sb, ship, aliens, bullets):
	...
	if collisions:
		effect = pg.mixer.Sound('/Users/min/Downloads/SuperMario/smw_kick.wav')
		effect.play()
